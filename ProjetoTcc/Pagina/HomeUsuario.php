...
<nav class="mb-4 navbar navbar-expand-lg navbar-dark bg-unique">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent-3">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="CardapioDisponivelData.php">Cardápios Disponível <span class="sr-only">(current)</span></a>
            </li>
        </ul>
        <ul class="navbar-nav ml-auto nav-flex-icons">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-unique" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="SairUsuario.php">Sair</a>
                </div>
            </li>
        </ul>
    </div>
