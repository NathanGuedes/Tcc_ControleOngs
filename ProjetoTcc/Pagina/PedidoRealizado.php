...
echo '
		...
		<th bgcolor="#FFFFCC" scope="col" align="center">Ver Pedidos</th>
...
if ($result=mysqli_query($connection,$query)) {
    while ($dados = mysqli_fetch_assoc($result)) {
        ...
        if ($par % 2) {
            echo('<tr><td align="center">'.$C_Cardapio.'</td><td align="center">'.$DataServ.'</td><td align="center">'.$descricao.'</td><td align="center"><a href = "PedidoRealizado2.php?codigo='.$C_Cardapio.'">Ver Pedidos</a></td></tr>');
        }
        else {
            echo('<tr><td align="center">'.$C_Cardapio.'</td><td align="center">'.$DataServ.'</td><td align="center">'.$descricao.'</td><td align="center"><a href = "PedidoRealizado2.php?codigo='.$C_Cardapio.'">Ver Pedidos</a></td></tr>');        }
